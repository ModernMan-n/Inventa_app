...
function App() {
  ...
  return (
    <div className="app-root">
      ...
      {isMappingModalOpen && (
        <div className="modal-backdrop" onClick={() => setIsMappingModalOpen(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mapping-grid">
              ...
              <label className="mappingField">
                <span>Наименоваие ОС *</span>
                <CustomSelect
                  label="Наименование ОС *"
                  value={mappingDraft.name}
                  options={availableColumns}
                  onChange={(v) => setMappingDraft((prev) => ({ ...prev, name: v }))}
                />
              </label>
      ...
      {isFontModalOpen && (
        <div className="modal-backdrop" onClick={() => setIsFontModalOpen(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <ol className="modal-list">
              ...
              <li>
                Нажмите кнопку <b>«Установить»</b> (в Windows) или добавьте шрифт
                в «Шрифты» (macOS).
              </li>
